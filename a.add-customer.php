<?php 
    ...
    if (isset($_GET['id'])) {
        $customer = $con->prepare("select * from customer  where  customerID = :id ");
       ...
       <div class="page-wrapper">
           ...
           <div class="row page-titles card-extra">
               <div class="col-md-5 align-self-center">
                   <h3 class="text-primary">Change customer details</h3> </div>
               <div class="col-md-7 align-self-center">
                   <ol class="breadcrumb">
                       <li class="breadcrumb-item"><a href="a-index.php">Home</a></li>
                       <li class="breadcrumb-item active"><a href="a.manage-customer.php"> View customers</a> </li>
                       <li class="breadcrumb-item active">Change customer </li>
                   </ol>
               </div>
           </div>
                       ...
                       <div class="card card-extra">
                           ...
                           <div class="card-body">
                               <div class="input-states">
                                   ...
                                   <div class="col-md-12"> 
                                      <input type="submit" name="changeCustomer" value="Change" style="background-color: #102b49; border-radius: .8rem; padding: .6rem;" class="text-white btn  btn-flat m-b-25 m-t-5 form-control">
                                   </div>
                                   </form>
                               </div>
                           </div>
...
?>   
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles card-extra">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Register customer</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="a-index.php">Home</a></li>
                        <li class="breadcrumb-item active"><a href="a.manage-customer.php"> View customers</a> </li>
                        ...
                        <div class="card card-extra">
                            ...
                            <div class="card-body">
                                <div class="input-states">
                                    ...
                                    <div class="col-md-12"> 
                                       <input type="submit" name="register" value="Register" style="background-color: #102b49; border-radius: .8rem; padding: .6rem;" class="text-white btn  btn-flat m-b-25 m-t-5 form-control">
                                    </div>
                                    </form>
                                </div>
                            </div>
