...
<meta name="author" content="Mayuri K">
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="assets/uploadImage/logo.jpeg">
    <title>Multi channel garage management system</title>
...
<script type="text/javascript" src='custom/js/jquery-select.js'></script>
