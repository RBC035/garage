       ...
       <div class="page-wrapper">
            ...
            <div class="row page-titles card-extra">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary"> View solved problems</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="c-index.php">Home</a></li>
                        <li class="breadcrumb-item active">View solved problems</li>
                    </ol>
                </div>
            </div>
                                    ...
                                    <table id="myTable" class="table table-bordered table-hover">
                                       ...
                                       <tbody>
                                        <?php
                                            ...
                                            $customer->execute([$_SESSION['user'], "Solved"]);
                                        ...
                                        <tr>
                                            ...
                                            <td class="table-td"><?php echo $row->district; ?></td>
                                             ...
                                             <td class="table-td"><?php echo $row->status; ?></td>
                                            <td>
