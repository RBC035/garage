       ...
       <div class="page-wrapper">
            ...
            <div class="row page-titles card-extra">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="o.manage-service.php">View garage details</a></li>
            ...
            <div class="container-fluid">
                 ...
                 <div class="card card-extra">
                            ...
                            <a href="o.add-service.php?id=<?php echo $_GET['id'];?>"><button class="btn btn-primary">Register service</button></a>
